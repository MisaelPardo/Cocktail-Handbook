...
class AuthService {
  ...
  // Ajuste Técnico: Construtor preparado para receber instâncias simuladas (Mocks)
  // Se nenhum parâmetro for passado (no resto do app), ele usa as instâncias padrão do Firebase.
  AuthService({
    FirebaseAuth? auth,
